...
def config_mlflow():
    os.environ['MLFLOW_TRACKING_USERNAME'] = 'castrien'
    os.environ['MLFLOW_TRACKING_PASSWORD'] = 'RZYvi@3skpFzCWs'
    mlflow.set_tracking_uri('https://dagshub.com/castrien/mlops-ead.mlflow')
